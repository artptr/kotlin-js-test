...
@file:[JsModule("fs") JsQualifier("lchmod")]
package fs.lchmod
...
external fun __promisify__(path: url.URL, mode: String): Promise<Unit> = definedExternally
external fun __promisify__(path: url.URL, mode: Number): Promise<Unit> = definedExternally
