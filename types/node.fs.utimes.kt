...
external fun __promisify__(path: url.URL, atime: String, mtime: dynamic /* String | Number | Date */): Promise<Unit> = definedExternally
external fun __promisify__(path: url.URL, atime: Number, mtime: dynamic /* String | Number | Date */): Promise<Unit> = definedExternally
external fun __promisify__(path: url.URL, atime: Date, mtime: dynamic /* String | Number | Date */): Promise<Unit> = definedExternally
