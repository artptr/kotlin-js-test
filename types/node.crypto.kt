...
external interface Certificate {
    ...
    companion object {
        @nativeInvoke
        operator fun invoke(): `"crypto".Certificate`
    }
}
...
external interface Hash : NodeJS.ReadWriteStream {
    ...
    fun update(data: DataView, input_encoding: String /* "ascii" */): Hash
    fun update(data: DataView, input_encoding: String /* "utf8" */): Hash
    fun update(data: DataView, input_encoding: String /* "latin1" */): Hash
    fun digest(): Buffer
...
external interface Hmac : NodeJS.ReadWriteStream {
    ...
    fun update(data: DataView, input_encoding: String /* "ascii" */): Hmac
    fun update(data: DataView, input_encoding: String /* "utf8" */): Hmac
    fun update(data: DataView, input_encoding: String /* "latin1" */): Hmac
    fun digest(): Buffer
    fun digest(encoding: String /* "base64" */): String
    fun digest(encoding: String /* "latin1" */): String
    fun digest(encoding: String /* "hex" */): String
...
external interface Cipher : NodeJS.ReadWriteStream {
    ...
    fun update(data: DataView): Buffer
    ...
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "base64" */): String
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "binary" */): String
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "hex" */): String
    ...
    fun setAAD(buffer: Buffer): Cipher /* this */
}
...
external interface Decipher : NodeJS.ReadWriteStream {
    ...
    fun update(data: Buffer, input_encoding: Any, output_encoding: String /* "binary" */): String
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "ascii" */): String
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "utf8" */): String
    fun update(data: DataView, input_encoding: Any, output_encoding: String /* "binary" */): String
    ...
    fun setAuthTag(tag: Buffer): Decipher /* this */
    fun setAAD(buffer: Buffer): Decipher /* this */
}
...
external interface Signer : NodeJS.WritableStream {
    ...
    fun update(data: DataView): Signer
    ...
    fun update(data: DataView, input_encoding: String /* "ascii" */): Signer
    fun update(data: DataView, input_encoding: String /* "utf8" */): Signer
    fun update(data: DataView, input_encoding: String /* "latin1" */): Signer
    fun sign(private_key: String): Buffer
    fun sign(private_key: `T$89`): Buffer
    ...
    fun sign(private_key: `T$89`, output_format: String /* "base64" */): String
    fun sign(private_key: `T$89`, output_format: String /* "latin1" */): String
    fun sign(private_key: `T$89`, output_format: String /* "hex" */): String
}
...
external interface Verify : NodeJS.WritableStream {
    ...
    fun update(data: DataView): Verify
    ...
    fun update(data: DataView, input_encoding: String /* "ascii" */): Verify
    fun update(data: DataView, input_encoding: String /* "utf8" */): Verify
    fun update(data: DataView, input_encoding: String /* "latin1" */): Verify
    fun verify(`object`: String, signature: Buffer): Boolean
    fun verify(`object`: String, signature: DataView): Boolean
    fun verify(`object`: Any, signature: Buffer): Boolean
    fun verify(`object`: Any, signature: DataView): Boolean
...
external interface ECDH {
    fun convertKey(key: String, curve: String, inputEncoding: String? = definedExternally /* null */, outputEncoding: String? = definedExternally /* null */, format: String? = definedExternally /* null */): dynamic /* String | Buffer */
    fun convertKey(key: Buffer, curve: String, inputEncoding: String? = definedExternally /* null */, outputEncoding: String? = definedExternally /* null */, format: String? = definedExternally /* null */): dynamic /* String | Buffer */
    fun convertKey(key: DataView, curve: String, inputEncoding: String? = definedExternally /* null */, outputEncoding: String? = definedExternally /* null */, format: String? = definedExternally /* null */): dynamic /* String | Buffer */
    fun generateKeys(): Buffer
    fun generateKeys(encoding: String /* "base64" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "base64" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "base64" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "latin1" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "latin1" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "latin1" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "hex" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "hex" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun generateKeys(encoding: String /* "hex" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun computeSecret(other_public_key: Buffer): Buffer
    fun computeSecret(other_public_key: String, input_encoding: String /* "base64" */): Buffer
    fun computeSecret(other_public_key: String, input_encoding: String /* "latin1" */): Buffer
    fun computeSecret(other_public_key: String, input_encoding: String /* "hex" */): Buffer
    ...
    fun getPrivateKey(encoding: String /* "hex" */): String
    fun getPublicKey(): Buffer
    fun getPublicKey(encoding: String /* "base64" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "base64" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "base64" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "latin1" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "latin1" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "latin1" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "hex" */, format: String? /* "compressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "hex" */, format: String? /* "uncompressed" */ = definedExternally /* null */): String
    fun getPublicKey(encoding: String /* "hex" */, format: String? /* "hybrid" */ = definedExternally /* null */): String
    fun setPrivateKey(private_key: Buffer)
