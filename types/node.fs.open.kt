...
external fun __promisify__(path: url.URL, flags: String, mode: dynamic /* String? | Number? */ = definedExternally /* null */): Promise<Number> = definedExternally
external fun __promisify__(path: url.URL, flags: Number, mode: dynamic /* String? | Number? */ = definedExternally /* null */): Promise<Number> = definedExternally
